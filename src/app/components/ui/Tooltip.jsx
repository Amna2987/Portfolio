    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href='mailto:amnamajeed2987@gmail.com' aria-label="Email" data-social="spotify" target='_blank'>
            ...
            <svg viewBox="0 0 24 24" fill="white" height="1.5em" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z" />
                        </svg>
          </a>
          <div className="tooltip">Email:amnamajeed2987@gmail.com</div>
        </li>
        <li className="icon-content">
          <a href='tel:+923274059035' aria-label="Tel" data-social="pinterest" target='_blank'>
            <div className="filled" />
          ...
          <div className="tooltip">Call:+923274059035</div>
        </li>
        <li className="icon-content">
          <a href='sms:+923274059035' aria-label="Sms" data-social="dribbble" target='_blank'>
            <div className="filled" />
            {/* <svg version="1.1" viewBox="0 0 100 100">
          ...
          <div className="tooltip">Message:+923274059035</div>
        </li>
        <li className="icon-content">
          <a href='https://github.com/amna2987' aria-label="Github" data-social="telegram" target='_blank'>
            <div className="filled" />
            {/* <svg version="1.1" viewBox="0 0 100 100">
          ...
          <div className="tooltip">https://github.com/amna2987</div>
        </li>
      </ul>
    </StyledWrapper>
  );
